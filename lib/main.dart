        ...
        NavigationDelegate(
          onPageFinished: (url) async {
            ...
            if (url.contains(postLoginIndicator) ||
              ...
              debugPrint('[Receipt Vault] Saved cookies ⇒ $raw');
            }
          },
      ...
      if (parts.length == 2) {
        ...
        await WebViewCookieManager().setCookie(
          WebViewCookie(
            name: name,
            value: value,
            domain: "www.receiptvault.com",  // adjust if needed (no www, subdomain, etc.)
            path: "/",
          ),
        );
      }
    }
    debugPrint('[Receipt Vault] Re-injected ${saved.split(';').length} cookies');
  }
